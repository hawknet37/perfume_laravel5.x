...
class CheckoutController extends Controller
{
    ...
    public function vnpay_payment(Request $request){
            ...
            $vnp_OrderInfo = 'Thanh toan don hang test Mihawk Perfume';
...
// }
    public function add_customer(Request $request){
        ...
        'customer_password' => 'required|min:5|regex:/^(?=.*?[0-9]).{5,}$/',
        ...
        'customer_password.min' => 'Vui lòng điền mật khẩu ít nhất 5 chữ cái và ít nhất 1 chữ số',
        'customer_password.regex' => 'Vui lòng điền mật khẩu ít nhất 5 chữ cái và ít nhất 1 chữ số',
