...
class CategoryProduct extends Controller
{
    ...
    public function save_category_product(Request $request){
        ...
        'category_name.unique' => 'Tên loại sản phẩm đã tồn tại, vui lòng chọn tên khác',

       
        'category_product_keywords.required' => 'Vui lòng điền từ khóa loại sản phẩm',
        'slug_category_product.required' => 'Vui lòng điền slug loại sản phẩm',
        ...
        // Session::put('message','Thêm loại sản phẩm');
    ...
    public function unactive_category_product($category_product_id){
        ...
        Toastr::success('Tắt kích hoạt loại sản phẩm thành công','Thành công');
