...
class MailController extends Controller
{
    ...
    public function recover_password(Request $request){
        ...
        $title_mail= "Lấy lại mật khẩu mihawkperfume.com".' '.$now;
    ...
    public function reset_password(Request $request)
    {
        ...
        if (!$customer) {
            Toastr::error('Không tìm thấy khách hàng', 'Thất bại');
            return redirect()->to('/view-reset-password');
        }
        ...
        if ($new_password !== $confirm_password) {
            Toastr::error('Mật khẩu không khớp, vui lòng nhập lại', 'Thất bại');
            return redirect()->to('/view-reset-password');
        }
        ...
        return redirect()->to('/view-reset-password')->with('logout_after_success', true);
    }
}