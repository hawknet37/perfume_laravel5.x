...
<body>
    <div class="contianer" style="background: #47a447; border-radius:12px;padding:15px;">
        <div class="col-md-12">
            ...
            <div class="col-md-6" style="text-align: center; color:#fff; font-weight: bold; font-size:30px;">
                <h4 style="margin:0">CÔNG TY MIHAWK PERFUME</h4>
                <h6 style="margin:0">DỊCH VỤ BÁN NƯỚC HOA CHẤT LƯỢNG CAO CẤP</h6>
            </div>
            ...
            <p style="color: #fff;">Mọi chi tiết xin liên hệ website tại: <a target="_blank" href="http://mihawkperfume.com/shopperfume_laravel/">Shop</a>, hoặc liên hê qua số hotline: 19005689. Xin cảm ơn quý khách đã đặt hàng shop chúng tôi.</p>
        </div>
    </div>
</body>
