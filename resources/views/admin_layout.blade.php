      ...
      <aside class="sidebar-left">
        <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1>
              <a class="navbar-brand" href="{{url('/dashboard')}}"><span class="fa fa-area-chart"></span> Perfume<span
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                <a href="{{url('/dashboard')}}">
                  <i class="fa fa-dashboard"></i> <span>Thống kê doanh thu</span>
                </a>
              </li>
