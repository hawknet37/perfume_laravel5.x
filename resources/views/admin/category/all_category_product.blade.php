...
<div class="tables">
  <div class="row align-items-center">
    <div class="col-md-6">
        <h2 class="title1">Liệt kê loại sản phẩm</h2>
    </div>
    <div class="col-md-6 text-right px-0">
        <a href="{{ URL::to('/add-category-product/') }}" class="btn btn-primary" ui-toggle-class="">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a onclick="return confirm('Bạn có chắc là muốn xóa loại sản phẩm này ko?')"
